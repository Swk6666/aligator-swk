...
IF(NOT EXISTS "/Users/swk/Documents/swk/could delete/aligator/dual-FFSR_ProxDDP/_deps/jrl-cmakemodules-build/install_manifest.txt")
  RETURN()
ENDIF(NOT EXISTS "/Users/swk/Documents/swk/could delete/aligator/dual-FFSR_ProxDDP/_deps/jrl-cmakemodules-build/install_manifest.txt")
...
IF(EXISTS "/install_manifest.txt")
  return()
ENDIF()
FILE(READ "/Users/swk/Documents/swk/could delete/aligator/dual-FFSR_ProxDDP/_deps/jrl-cmakemodules-build/install_manifest.txt" files)
STRING(REPLACE "\n" ";" files "${files}")
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND ${CMAKE_COMMAND} -E remove "/Users/swk/Documents/swk/could delete/aligator/dual-FFSR_ProxDDP/_deps/jrl-cmakemodules-build/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
